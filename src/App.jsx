...
import ModalSide from "./compoents/modal.jsx";

const App = () => {
    const [open, setOpen] = useState(false);
    let aksiyaPrice = useMemo(() => {
        ...
        <div className='all'>
            <div className='card'>
                ...
                <div className='card-body'>
                    ...
                    <div className='gr'>
                        <p className='card-aksiya'>{aksiyaPrice}</p>
                        <button onClick={openHandel}>
                            <svg
                                width='24'
                                height='24'
                                viewBox='0 0 24 24'
            ...
            {open && <ModalSide a={open} b={setOpen} data={data.type} />}
        </div>  
    );
};
